    ...
    <div class="flex h-screen">
        ...
        <div class="w-48 bg-gradient-to-b from-indigo-900 to-indigo-800 text-white shadow-2xl">
            ...
            <nav class="mt-8 space-y-2 px-4">
                ...
                <a href="habitaciones.jsp" class="flex items-center space-x-3 px-4 py-3 bg-indigo-700 rounded-lg hover:bg-indigo-600 transition">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="bg-white shadow-md px-8 py-4 flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Gestión de Habitaciones</h2>
                    <p class="text-gray-600 text-sm">Control completo del inventario de habitaciones</p>
                </div>
            ...
            <div class="flex-1 overflow-auto">
                <div class="p-8">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800">Estado de Habitaciones</h3>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" id="summaryCards">
                        ...
                        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-green-100 text-sm font-semibold">Disponibles</p>
                                    <h3 class="text-4xl font-bold mt-2" id="disponibles">0</h3>
                                    <p class="text-green-100 text-xs mt-1">habitaciones</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl p-6 text-white shadow-lg">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-red-100 text-sm font-semibold">Ocupadas</p>
                                    <h3 class="text-4xl font-bold mt-2" id="ocupadas">0</h3>
                                    <p class="text-red-100 text-xs mt-1">habitaciones</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white shadow-lg">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-orange-100 text-sm font-semibold">Mantenimiento</p>
                                    <h3 class="text-4xl font-bold mt-2" id="mantenimiento">0</h3>
                                    <p class="text-orange-100 text-xs mt-1">habitaciones</p>
                                </div>
                                <i class="fas fa-wrench text-3xl opacity-30"></i>
                            </div>
                        </div>
                    </div>

                    <!-- Habitaciones Grid -->
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="habitacionesGrid">
