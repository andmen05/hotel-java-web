                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 mb-6 border border-gray-100">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="text" id="buscarHabitacion" placeholder="ID, tipo, precio, capacidad..." class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
                            </div>
                            <div>
            ...
            <form id="formHabitacion" onsubmit="guardarHabitacion(event)" class="p-6 space-y-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                        <span class="material-icons-outlined mr-2 text-indigo-600 text-sm">meeting_room</span>
                        ID Habitación
                    </label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                        <span class="material-icons-outlined mr-2 text-indigo-600 text-sm">bed</span>
                        Tipo de Habitación
                    </label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                        <span class="material-icons-outlined mr-2 text-indigo-600 text-sm">info</span>
                        Estado
                    </label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                        <span class="material-icons-outlined mr-2 text-indigo-600 text-sm">attach_money</span>
                        Precio por Noche
                    </label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                        <span class="material-icons-outlined mr-2 text-indigo-600 text-sm">people</span>
                        Capacidad (personas)
                    </label>
