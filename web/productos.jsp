...
<head>
    ...
    <title>Productos - Hotel Paradise</title>
    ...
    <div class="flex h-screen">
        <aside class="w-64 flex-shrink-0 bg-indigo-900 text-indigo-100 flex flex-col">
            ...
            <nav class="flex-1 px-4 space-y-2">
                ...
                <a class="flex items-center px-4 py-2.5 bg-primary text-white rounded-lg font-semibold" href="productos.jsp">
        ...
        <main class="flex-1 flex flex-col overflow-y-auto">
            <header class="flex-shrink-0 bg-white border-b border-gray-200 p-6 flex justify-between items-center sticky top-0 z-10">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Gestión de Productos - Restaurante</h2>
                    <p class="text-sm text-gray-500">Administra el menú y el inventario</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-3">
                            <button onclick="exportarExcel()" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition flex items-center space-x-2 font-semibold text-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
                        <div class="bg-white p-5 rounded-lg shadow-sm flex items-center justify-between border border-gray-100">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1" id="totalProductos">0</p>
                                <p class="text-xs text-gray-400">En inventario</p>
                            </div>
                        ...
                        <div class="bg-white p-5 rounded-lg shadow-sm flex items-center justify-between border border-gray-100">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1" id="stockBajo">0</p>
                                <p class="text-xs text-gray-400">Requieren reorden</p>
                            </div>
                        ...
                        <div class="bg-white p-5 rounded-lg shadow-sm flex items-center justify-between border border-gray-100">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1" id="proximosVencer">0</p>
                                <p class="text-xs text-gray-400">En 30 días</p>
                            </div>
                        ...
                        <div class="bg-white p-5 rounded-lg shadow-sm flex items-center justify-between border border-gray-100">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1" id="valorTotal">$0</p>
                        ...
                        <div class="bg-white p-5 rounded-lg shadow-sm flex items-center justify-between border border-gray-100">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1" id="margenPromedio">0%</p>
                                <p class="text-xs text-gray-400">Rentabilidad</p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 mb-6 border border-gray-100">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="text" id="buscarProducto" placeholder="Nombre, código..." class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-2">Categoría</label>
                                <select id="filtroCategoria" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
                            ...
                            <div>
                                ...
                                <select id="filtroEstado" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-primary">
                                    ...
                                    <option value="vencer">Próximos a Vencer</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-2">Rango Precio</label>
                                <input type="range" id="filtroRango" min="0" max="100000" step="1000" value="100000" class="w-full">
                                <p class="text-xs text-gray-500 mt-1">$0 - $<span id="rangoValor">100000</span></p>
                            </div>
                        </div>
                        <div class="mt-3 flex justify-end">
                            <button type="button" onclick="limpiarFiltros()" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition flex items-center space-x-2 font-semibold text-sm">
                            ...
                            <table class="w-full text-sm">
                                <thead class="bg-gray-50 border-b border-gray-200 sticky top-0">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-left font-semibold text-gray-700">Precio Venta</th>
                                        <th class="px-4 py-3 text-left font-semibold text-gray-700">Stock</th>
                                        <th class="px-4 py-3 text-left font-semibold text-gray-700">Margen</th>
            ...
            <form id="formProducto" onsubmit="guardarProducto(event)" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="precioVenta" required class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 transition" placeholder="Ej: 50000">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-shopping-cart mr-2 text-indigo-600"></i>Precio Compra
                        </label>
                        <input type="number" id="precioCompra" required class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 transition" placeholder="Ej: 30000">
                    </div>
                </div>
